...
namespace NihFix.PgProfiler.Ui
{
    public class Startup
    {
        ...
        public async Task Bootsrap()
        {
           
             await Electron.WindowManager.CreateWindowAsync();
             Electron.WindowManager.BrowserWindows.First().WebContents.OpenDevTools();
             var logChangeTracker=new LogChangeTracker(@"D:\postgres\data\log");
             Electron.IpcMain.On("subscribeToProfilerData", (l) =>
             {
                 logChangeTracker.OnLogChange += (sender, args) =>
